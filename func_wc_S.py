...
# Guardar los resultados en la variable 'S_3_T'
    ...
    S_3_T_df = pd.DataFrame(S_3_T, index=['S_T_cuad1_3m','S_T_cuad2_3m','S_T_cuad3_3m','S_T_cuad4_3m']).T
...
# Guardar los resultados en la variable 'S_3_q'
    ...
    S_3_q_df = pd.DataFrame(S_3_q, index=['S_q_cuad1_3m','S_q_cuad2_3m','S_q_cuad3_3m','S_q_cuad4_3m']).T
